...
import pytest
from mlscores.scores import calculate_language_percentage, calculate_language_percentages, calculate_language_percentage_for_languages
...
def test_multiple_properties_multiple_languages():
    ...
    assert calculate_language_percentages(properties) == pytest.approx(expected_result, rel=1e-2)
...
def test_properties_with_multiple_languages_and_duplicates():
    properties = [('prop1', 'value1', 'en'), ('prop2', 'value2', 'fr'), ('prop3', 'value3', 'en'), ('prop1', 'value1', 'en')]
    expected_result = {'en': 66.67, 'fr': 33.33}
    assert calculate_language_percentages(properties) == pytest.approx(expected_result, rel=1e-2)
...
def test_empty_properties():
    ...
    assert calculate_language_percentage_for_languages(properties, languages) == expected_result
...
def test_multiple_properties_multiple_languages():
    ...
    languages = ['en', 'fr']
    expected_result = {'en': 66.67, 'fr': 33.33}
    assert calculate_language_percentage_for_languages(properties, languages) == pytest.approx(expected_result, rel=1e-2)
